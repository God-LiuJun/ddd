...
#project structure
args["CODE_DIRECTORY"] = "/home/liujun666/deep_avsr/video_only/"   #absolute path to the code directory
args["DATA_DIRECTORY"] = "/public/dataset/LRS2/mvlrs_v1/"   #absolute path to the data directory
args["DEMO_DIRECTORY"] = "/public/dataset/LRS2/mvlrs_v1/main/5535415699068794046"   #absolute path to the demo directory
args["PRETRAINED_MODEL_FILE"] = "/final/models/video_only.pt"     #relative path to the pretrained model file
...
args["TRAINED_FRONTEND_FILE"] = "/home/liujun666/deep_avsr/video_only/final/models/visual_frontend.pt" #absolute path to the trained visual frontend file
